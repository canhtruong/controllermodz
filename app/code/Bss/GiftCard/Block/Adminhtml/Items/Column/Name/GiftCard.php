...
class GiftCard extends ColumnName
{
    ...
    private function getStoreId()
    {
        ...
        } else if (in_array($fullActionPath, $pageNew)) {
            // We can get order_id from params
            $orderId = $this->getRequest()->getParam('order_id');
            $order = $this->orderRepository->get($orderId);
            return $order->getStoreId();
        } else if ($fullActionPath === "sales_order_invoice_view") {
            /** @var \Magento\Sales\Model\Order\Invoice $invoice */
            $invoice = $this->_coreRegistry->registry('current_invoice');
            return $invoice->getStoreId();
        } else if ($fullActionPath === "adminhtml_order_shipment_view") {
        ...
        } else if ($fullActionPath === "sales_order_creditmemo_view") {
