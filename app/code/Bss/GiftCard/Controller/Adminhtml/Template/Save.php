 ...
 * Class Save
 *
 * @package Bss\GiftCard\Controller\Adminhtml\Template
 */
        ...
        if ($params['template_id']) {
            ...
            if (!$templateModel->checkBeforeDisableTemplate($params)) {
                $this->messageManager->addErrorMessage(
                    __('There are some products using this Template. Please delete them first. (Template Id: %1)', $params['template_id'])
                );
