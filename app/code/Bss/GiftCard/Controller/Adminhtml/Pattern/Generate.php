 ...
 * Class Generate
 *
 * @package Bss\GiftCard\Controller\Adminhtml\Pattern
 */
class Generate extends AbstractGiftCard
{
    ...
    public function execute()
    {
        ...
        if (isset($patternId) && isset($generateQty) && isset($amount)) {
            try {
                ...
                if (!$pattern->validateQtyCode($generateQty)) {
                    ...
                    if ($codeModel->generateCodes($pattern, $data)) {
                        $result = [
                            ...
                            'message' => __('%1 coupon(s) have been generated.', $generateQty)
                        ];
                    }
                }
            } catch (\Exception $e) {
