...
define([
    ...
    'mage/calendar'
], function (ko, _, Component, $, Preview, $t) {
    'use strict';
    ...
    return Component.extend({
        ...
        initObservable: function () {
            ...
            this.selectAmount.subscribe(function(value) {
                if (value === 'custom') {
                    ...
                    self.updatePriceBox(self.changeAmount(), true);
                } else {
                    var price = 0,
            ...
            this.changeAmount.subscribe(function(value) {
                self.updatePriceBox(value, true);
            });
        ...
        updatePriceBox: function (val, custom) {
            ...
            $('#product-price-' + productId).trigger('updatePrice', changes);
        },
