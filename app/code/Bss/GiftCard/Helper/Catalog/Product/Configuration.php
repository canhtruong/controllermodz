 ...
 * Class Configuration
 *
 * @package Bss\GiftCard\Helper\Catalog\Product
 */
class Configuration extends AbstractHelper implements ConfigurationInterface
{
    const GIFTCARD_AMOUNT = 'bss_giftcard_amount';

    const GIFTCARD_AMOUNT_DYNAMIC = 'bss_giftcard_amount_dynamic';

    const GIFTCARD_SENDER_NAME = 'bss_giftcard_sender_name';

    const GIFTCARD_SENDER_EMAIL = 'bss_giftcard_sender_email';

    const GIFTCARD_RECIPIENT_NAME = 'bss_giftcard_recipient_name';

    const GIFTCARD_RECIPIENT_EMAIL = 'bss_giftcard_recipient_email';

    const GIFTCARD_MESSAGE_EMAIL = 'bss_giftcard_message_email';

    const GIFTCARD_DELIVERY_DATE = 'bss_giftcard_delivery_date';

    const GIFTCARD_TIMEZONE = 'bss_giftcard_timezone';

    const GIFTCARD_TEMPLATE = 'bss_giftcard_template';

    const GIFTCARD_IMAGE = 'bss_giftcard_selected_image';
