...
define([
    ...
    return Component.extend({
        ...
        isBssGiftCard: function () {
            const itemsData = window.checkoutConfig.quoteItemData;
            if (itemsData && itemsData.length === 1) {
                return itemsData[0].product_type === 'bss_giftcard'
            }
            return false
        },
        /**
                ...
                else
                {
                    if ((quote.isVirtual() || !quote.shippingAddress())) {
                        ...
                        if (!this.isAddressSameAsShipping() && (newAddress !== null && typeof newAddress === 'object' && !newAddress.regionId && (!newAddress.street || !newAddress['street'][0]))) {
                            ...
                            window.isAddressSameAsShipping = newAddress != null &&
                                newAddress.getCacheKey() === quote.shippingAddress().getCacheKey();
                        }
                    }
                }

                if (newAddress != null && newAddress.saveInAddressBook) {
                    console.log('newAddress.saveInAddressBook:', newAddress.saveInAddressBook)
                    this.saveInAddressBook(newAddress.saveInAddressBook);
                } else {
                    console.log('Go here 148')
